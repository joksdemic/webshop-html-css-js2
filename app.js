...
document.addEventListener('DOMContentLoaded', function() {
    // Selektovanje svih radio dugmadi
    document.querySelectorAll('input[name="payment-method"]').forEach(function(radio) {
        radio.addEventListener('change', function() {
            ...
            // Prikazivanje odgovarajuće forme na osnovu izabrane opcije
            if (this.value === 'pouzecem') {
                document.getElementById('pouzecem-form').classList.add('active');
            } else if (this.value === 'karticom') {
                document.getElementById('karticom-form').classList.add('active');
